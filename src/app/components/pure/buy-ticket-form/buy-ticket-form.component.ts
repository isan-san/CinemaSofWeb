...
export class BuyTicketFormComponent {
  ...
  onSubmit() {
    const formValues: FormValues = {
      ...
      cardNumber:
        this.selectedPaymentMethod === 'credit' ? this.cardNumber : undefined,
      paypalEmail:
        this.selectedPaymentMethod === 'paypal' ? this.paypalEmail : undefined,
      bitcoinAddress:
        this.selectedPaymentMethod === 'bitcoin'
          ? this.bitcoinAddress
          : undefined,
    };
